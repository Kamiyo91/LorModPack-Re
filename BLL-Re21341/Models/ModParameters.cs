...
namespace BLL_Re21341.Models
{
    public static class ModParameters
    {
        ...
        public static readonly List<int> UntransferablePassives = new List<int> {6,8};
        public static readonly Dictionary<int,List<int>> KeypageWithOnlyCardsList = new Dictionary<int, List<int>> { {10000001,new List<int>{3,4,5,6,7}}, { 10000003, new List<int> {12, 13, 14, 15} } };
    }
}
